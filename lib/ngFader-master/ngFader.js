(function () {
    ...
    angular.module('ngFader', [])
      .directive('ngFader', function($interval, ImgurFactory, ClusterFactory, $routeParams) {


	  function link($scope, scope){
